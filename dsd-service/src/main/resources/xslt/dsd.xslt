...
<xsl:stylesheet
    ...
    xmlns:xalan="http://xml.apache.org/xslt" xmlns:xls="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:function name="dsd:reverse" as="xs:string">
    <xsl:param name="sentence" as="xs:string"/>
    <xsl:sequence
        select="if (contains($sentence, ' '))
             then concat(dsd:reverse(substring-after($sentence, ' ')),
                         ' ',
                ...
                <rim:SlotValue xsi:type="rim:AnyValueType">
                  ...
                  <dcat:dataset xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
                    ...
                    <dcat:distribution>
                      ...
                      <dct:description>
                        <xsl:value-of select="normalize-space(concat('?This is a pdf distribution of the ', $datasetType, '?'))"/>
                      </dct:description>
                    ...
                    <dct:publisher xsi:type="cagv:PublicOrganizationType">
                      ...
                      <cagv:location>
                        <cagv:address>
                          <!--
                            ...
                            -->
                          <locn:fullAddress>
                            <xsl:value-of select="normalize-space($match/entity)"/>
                          </locn:fullAddress>
                          <!-- country code -->
                          <locn:adminUnitLevel1>
                            <xsl:value-of select="$match/entity/countryCode"/>
                          </locn:adminUnitLevel1>
                      ...
                      <skos:prefLabel>
                        <xsl:value-of select="$match/entity/name"/>
                      </skos:prefLabel>
                    </dct:publisher>
                    <dct:type>
