...
public class ROARestQueryServlet extends HttpServlet {

  private static final Logger LOGGER = LoggerFactory.getLogger(ROARestQueryServlet.class);

  @Override
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
    LOGGER.debug("ROA query  with " + req.getQueryString());

    try {
      Map<String, String[]> parameterMap = req.getParameterMap();
      ROAQueryService.processRequest(parameterMap, resp.getOutputStream());
